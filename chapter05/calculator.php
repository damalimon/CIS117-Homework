...
include ('ch3includes/ch3header.html');

// Check for form submission:
if ($_SERVER['REQUEST_METHOD'] == 'POST') {

	// Here we validate the form has been submitted and our requirement that it contain numbers:
...
<?php include ('ch3includes/ch3footer.html'); ?>